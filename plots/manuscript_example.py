...
ger_nuts1_model = calliope.read_netcdf('calliope_model/results/de_nuts1-calliope-3h-80.nc')
ger_max_p_model = calliope.read_netcdf('calliope_model/results/de_max-calliope-3h-80.nc')
...
df_IC = pd.DataFrame()
techs= ['solar','wind', 'wind_offshore','cogeneration', 'heat_pump_air',
